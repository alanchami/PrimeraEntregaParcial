...
// Antes de las rutas. Esta funcion middleware lo que hace es dejar disponible los datos de sessión para todas las vistas
app.use(function(req, res, next){
 ...
 //Clave para que el proceso siga adelante.  
